        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondPosterPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesArtists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoviesArtists_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MoviesArtists_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesArtists_ArtistId",
                table: "MoviesArtists",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviesArtists_MovieId",
                table: "MoviesArtists",
                column: "MovieId");
